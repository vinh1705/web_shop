...
<div class="content-wrapper">
    ...
    <form action="{{route('PostAddPost', $id_categories)}}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="card card-primary">
                ...
                <div class="row justify-content-between col-lg-12">
                    <div class="custom-file col-lg-12" style="margin: 5px 0px;">
                        ...
                        <input type="file" class="custom-file-input" id="customFile" value="{{old('image1')}}" name="image1">
                ...
                <div class="form-group">
                    ...
                    <input name="title" value="{{old('title')}}" type="text" id="inputName" class="form-control" placeholder="Tên sản phẩm">
                </div>
                <div class="form-group">
